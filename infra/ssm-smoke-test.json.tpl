  ...
  "mainSteps": [
    {
      ...
      "inputs": {
        ...
        "runCommand": [
          ...
          "docker logs --tail 100 vertica_ce || true",
          ...
          "        return",
          "",
          "    print('[python] Installing vertica_python from embedded wheel', flush=True)",
          "    wheel_data = base64.b64decode(\"\"\"${vertica_python_wheel_b64}\"\"\")",
          "    tmp_dir = tempfile.mkdtemp(prefix='vertica_wheel_')",
          "    wheel_path = os.path.join(tmp_dir, 'vertica_python.whl')",
          "    with open(wheel_path, 'wb') as handle:",
          "        handle.write(wheel_data)",
          "",
          "    commands = [",
          "        [sys.executable, '-m', 'pip', 'install', '--quiet', '--no-deps', wheel_path],",
          "        [sys.executable, '-m', 'pip', 'install', '--quiet', '--no-deps', '--break-system-packages', wheel_path],",
          "    ]",
          "",
          "    last_error = None",
