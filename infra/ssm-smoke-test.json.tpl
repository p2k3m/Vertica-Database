  ...
  "mainSteps": [
    {
      ...
      "inputs": {
        ...
        "runCommand": [
          ...
          "META=$(curl -s --connect-timeout 2 --max-time 5 \"$${IMDS_HEADER[@]}\" http://169.254.169.254/latest/dynamic/instance-identity/document || true)",
          "echo '[debug] Instance identity document:'",
          "echo \"$META\"",
          "PUBLIC_IP=$(curl -s --connect-timeout 2 --max-time 5 \"$${IMDS_HEADER[@]}\" http://169.254.169.254/latest/meta-data/public-ipv4 || true)",
